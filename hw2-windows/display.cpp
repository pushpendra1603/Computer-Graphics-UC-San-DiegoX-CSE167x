...
void display() 
{
    //std::cout << ambient[0] << ambient[1] << ambient[2] << ambient[3] << "\n";
    // std::cout << sizeof(lightposn) << "\n";
    //for (int i = 0; i < numLights; i++) {
    //    vec4 lightpos = vec4(lightcolor[4 * i + 0], lightcolor[4 * i + 1], lightcolor[4 * i + 2], lightcolor[4 * i + 3]);
    //    std::cout << lightpos.x << " " << lightpos.y<< " " << lightpos.z << " " << lightpos.w << "\n";
    //}
